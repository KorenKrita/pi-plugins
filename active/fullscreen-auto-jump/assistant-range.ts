// Locate the final assistant message's *text* range inside a rendered document
// tree. Thinking blocks and tool calls are deliberately excluded: the jump target
// is where the human-readable answer begins.
//
// Ported from the fixed-input extension (fixed-editor/assistant-range.ts) so this
