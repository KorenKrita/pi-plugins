...
import type { ColorValue, CustomItemPosition, CustomStatusItem, PresetDef, StatusLineSegmentId, StatusLineSegmentOptions } from "./types.ts";
...
export function parsePowerlineConfig(value: unknown): PowerlineConfig {
  const defaultConfig: PowerlineConfig = { customItems: [], segmentOptions: {} };
